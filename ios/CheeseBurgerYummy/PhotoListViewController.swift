...
class PhotoListViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        Alamofire.request("http://192.168.0.9:8080/photo", method: .get, parameters: nil, encoding: JSONEncoding.default)
            .validate()
...
class CollectionViewCell: UICollectionViewCell {
    ...
    func fill(_ info: JSON) {
        Alamofire.request("http://192.168.0.9:8080\(info["image_thumb_file"])").response { (response) in
